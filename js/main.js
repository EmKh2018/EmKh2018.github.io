;(function () {
	...
	// Set the date we're counting down to
		var countDownDate = new Date("Apr 14, 2018 16:30:00").getTime();
		...
		// Display the result in an element with id="demo"
		document.getElementById("jours").innerHTML = days +" <small>jours</small>";
		document.getElementById("heures").innerHTML = hours + " <small>heures</small> ";
		document.getElementById("minutes").innerHTML = minutes + " <small>minutes</small> ";
		document.getElementById("secondes").innerHTML = seconds + " <small>secondes</small> ";
